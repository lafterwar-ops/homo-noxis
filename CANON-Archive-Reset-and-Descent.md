...
## 4. Ravar's shrine, and the deeper door (Jonah / bottom of the world)
Behind the light-door a **stair goes further down**, below the clock, below the reset, below the floor K took for the bottom of the world. At the bottom: a small room, a **shrine**, on every wall of it **Ravar's account cut deep** — this is where **Loss (ch23) and Build (ch24) now physically live** (engraved on the shrine walls, read by lamplight — NOT loose sheets in a beam). This relocation must be reflected when the frame voices are restored to Loss/Build.

- **Layer 3 (undecided):** the shrine has a further door, deeper still, into the true dark. Candidates: the "worst page" Ravar swore never to write (the workers' fate) / his own grave / only the dark itself. Left open.

## 4b. Ravar's proof-firing and departure (Build ending, locked 2026-07)
Ravar would not trust the system on faith. He **fired the Beast once himself**, with his own hand — ended the surface world one time — to prove that the weapon fired, the clock reset, and the reset/Archive brought the Mountain back up out of the ash. This is **the first of the five seams** in the Clock count (cycle 1's ending). The reset ran; his liturgy "came to pass"; and the great Archive proved to be **only a room, a clock, a way back — nothing holy — and it held.**

Then, knowing it would run without him forever, Ravar **left the Mountain** — walked out the mouth of it, alone, into the world he had just ended, "to see with my own eyes what I had done, and go down and face the deep" (Jonah). He engraved this intent in the shrine before leaving. **Consequences:** Ravar is NOT entombed in the Mountain (Layer 3 is therefore not his grave); the offices ran it without him from the start.
