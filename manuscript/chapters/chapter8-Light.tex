...
--- Watch, now, before I kill the lamp for good. I take its light, and I let it through the narrow slot, so that it comes to the glass as a single thin blade; and the glass bends each colour of it by that colour's own amount, and lays them all out in a row upon the screen. There. Look at what plain lamplight is made of.
