...
It never is. The thing was done.\\
...
Over all I set an eye that need not always wake,\\
for a soul that thinks itself watched keeps its own cell shut;\\
and I gave each hand its place, its use, its rung, its wall,\\
so none could stand where the whole might gather in one look.\\
\medskip
