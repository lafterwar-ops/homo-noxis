...
--- Part of it. The rest keeps for its place. And it was beautiful, and cruel, the way your kind always is both at once. A man named \textit{Kepler} gave his life to prove five perfect shapes ruled the spacing of the worlds. He said a thing I wrote down to keep:
...
--- A forest does not die in a day. Not by any weather I have read in the ground. Drought is a slow murder: ten years, a hundred, a thousand. What comes up between one dawn and one dusk, and leaves a desert where a forest stood?
...
--- \textit{Keep the secrets apart, let no one hand hold the whole.} A secret that cannot be surrendered whole, because no one of you holds it whole: the traitor, the captive, the fool with the loose tongue each carry only a fragment, and it outlives the weakest man who keeps it. It is sound engineering in the dress of scripture, and sound engineering is true whether or not a syllable of the account around it is.
