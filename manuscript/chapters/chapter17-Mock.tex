...
--- At lunch we called it surface sounding on three stations. We still have to establish that against the full array and determine what is making the strokes.

--- I recognise something I felt at a rising. I cannot account for the shorter wait.

--- Eleven minutes between strokes, and it has continued through the night. The old sequences stopped after five. Watch the drum. There is another.

\centerline{\textit{[\,Urs at the adjoining drum.\,]}}

--- The interval is holding: eleven minutes, near enough, between one and the next. It does not vary.

--- Bring me the drill cabinet, all of it back to the first paper I folded, and the great seals with it. Now, please.

--- I do not understand what I am looking at, and it is my trade to say so aloud. The old sequences followed a Keeper's death or an emergency call. These strokes resemble them, but the timing and the tail are wrong. I do not know what to call that.

--- Forgery. Someone has found a way to make this Mountain answer, is striking at it, and is writing down what comes back.
...
--- The first and third times that room was used after the confrontation. Both substitutions happened after we exposed the camera. Someone lost one channel and began drawing harder on another.
...
--- I have. Each fact alone is little. The wire could be yours under another name. The reels could have been changed for a technical reason no one gave me. The cases could hold money, medicine, reports, or nothing. Laid beside a hidden camera, Montel's collection, and your stolen grid, they will not lie down.
...
--- The camera gave us Montel as collector and Roger as carrier. The wire, reels, car, and grid give us a second shape inside the same house. They do not yet give us one owner.

--- Together they require an archive, border access, protected aircraft, field soldiers, and authority to erase a country from a vehicle. Montel gives it a French hand. He does not tell us which part of France commands the rest.
...
--- I am relieved. We are, the three of us, on one side of this for as long as that remains true. My Scottish father's version of the Auld Alliance was uranium for France. My English half is fighting France now. Try not to get us killed with the novelty.
...
--- Urs. Wake the parts of Horizon that are still mine, that never touched Martinez and do not know his masters exist. Open every route into that quarter the camp does not know it controls, and close the routes it believes it owns after we pass. You ran those roads against smugglers and competitors. Run them now against soldiers using my maps. Jean-Charles, you take the field when Elise gives you the tactical packet.
...
--- I hold the order and the identities. Urs opened the aircraft, fuel and vehicles without receiving the final ground. Each air crew holds only its own leg. The vehicle lead receives its road after the aircraft lands. Amastan's line knows the last ground and none of the air. Jean-Charles receives the tactical packet when we leave the final vehicle. Sarah knows where the pieces meet. No written page carries all of them.

--- And the recorder?

--- It remains in Mr Morgan's hand, manifested as Madame's medical instrument until the vehicle chain. After that it travels on his body. The fixed instruction reels go into the fire case with one copy of the route papers. If this house is entered after we leave, the case seals and the archive room burns separately. An intruder may take the house or follow us. He should not be able to do both from the same paper.
