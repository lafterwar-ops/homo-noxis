% Author's revised Covenant. The five books remain distinct from the received liturgy.
% Chapter quotations are maintained separately; recitations may use excerpts.

\section*{Book 1 --- Genesis}
...
\section*{Prayers and Responses}

% Received liturgy, distinct from the five narrative books.
% Restricted prayers and the later Shadow oath are not collected here.

\subsection*{The common response}
...
\subsection*{Over the gathered food}
...
\subsection*{At the meal}

\begin{verse}
There is mercy in the stone.\\
Bless the bread before us,\\
the hands that gathered it,\\
and the portion kept for those still at their work.
\end{verse}

\subsection*{Before the descent to work}

\begin{verse}
I set my hand upon Thy stone.\\
Keep it above me.\\
Let my children hear my step again.
\end{verse}

\subsection*{At admission to Light}
