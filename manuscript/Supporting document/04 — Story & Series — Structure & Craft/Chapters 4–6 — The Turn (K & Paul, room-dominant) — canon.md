...
2. **Ka-Orun** — who alone could **link the *mirage* to the tomb from which the proof was carried** (Ch10) — voices **only the shard the law allows:** *"About a mirage? You are correct — this is inconclusive."* He confirms; he does **not** state the link he holds. Two secrets, one mouth: forbidden — his restraint *is* the division of knowledge.
...
- **Dependency resolved:** the *mirage* is unmasked by **the tomb from which the proof was carried** (Ch10) — Ka-Orun makes that link, so "liar" is proof, not assertion. Wire the tomb→Oasis connection when Ch12 is reworked.
...
- **[Confirm]** the offices of **Ka-Orun** and **Ka-Dhavar** (two Keepers), and that **Justice** is the hand inheriting Sa-Tavan's tablets — so the fragments pass cleanly.
