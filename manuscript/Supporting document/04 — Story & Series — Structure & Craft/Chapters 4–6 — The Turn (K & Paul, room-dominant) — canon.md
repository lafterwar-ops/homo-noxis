...
**The documentary (Cosmos / the heavens).** K's reactions carry it: the beauty and the cruelty together, the cosmic splendour, and his regret that Kepler's five perfect solids did not, in the end, explain the world. The intellectual awe of Ch3 continues, but now it bends toward *trust*.

**The trust-methodology discussion (the philosophical spine).** K is in an epistemic crisis: *"In Cosmos, sometimes it was real, sometimes it was acting, sometimes I did not even know what it was."* He cannot chase a million questions one by one; he must learn to *choose* where to place trust. He puts it to Paul: **if not God, and if you are free, how do you choose whom to trust?** Paul answers as a scientist — one trusts what survives a test, what has earned it, what can be checked. *(A trap being set: K makes Paul name the rules, so the bargain K offers next runs in Paul's own currency.)* Beneath it, K — newly free the way the exiled are free — is learning to bear the liberty Sagan keeps praising; the covenant with Paul becomes **his first free choice.**

**The gift, and the ask (the field).** K offers a gift: to stand **under the open sky, the eye of heaven** — he who feared it at the Oasis — as proof of trust and progress. In return he asks one thing. Paul, accommodating, agrees. On open ground (the one place K believes has no ears but Paul's magneto), K makes the **mirror-check** ask — still *playful*, not yet an op: *"Will you trust me for a second and play my game?"* He asks Paul to go **behind the glass this afternoon**, in place of his usual room-work, and report whether there are people. And he frames it not as accusation but as a **defence of Sarah**: *are we sure it is Sarah watching her staff — and not Outsiders watching Sarah? Would anyone have reason to watch her?* (Paul: she heads a multinational, deals with important people — so, yes, it is possible.)

**The covenant (seeded).** The bargain attached to the mirror-check: **if K is proven right, Paul becomes loyal to K.** A falsifiable pact, framed in Paul's own method, which Paul can grant *lightly* precisely because he is sure the condition will never trigger — the pre-loaded switch for his whole eventual defection. Its blade: it is spoken onto the magneto — the very tape the enemy seizes — so K's most private act is recorded on the one device that betrays it.
...
## 2. Chapter 5 — The Proof *(the crack)*
...
## 4. Character & logic locks

- **Sarah Blackwood (Ka-Sarah):** revered, offstage, busy, unavailable — a Keeper. **No villain-tells** in how K or Paul speak of her. Her only "tell" is her unavailability, which must read as *reverence* until it can't. K does not accuse her; he *defends* her. Every warm word about the good Keeper should be true to how they see her and lethal in what they don't.
- **Paul:** sincere, compartmentalized, accommodating. His errand-win (K exercising) is banked. His method (trust what survives testing) is stated in Ch4 and confronted in Ch5. His disillusionment is *seeded* (the current-name tell, the men behind the glass) but he does **not break in Book 1.**
- **K:** runs on Mountain doctrine as survival method (facts first, defend first, understanding not required); his attention turning outward (the fast-forward account); the deposed commander reconstituting a tiny operation and binding one last liegeman — strategy and loneliness in the same breath.
- **The magneto irony:** K's covenant and plea, believed private, are recorded on the tape the enemy seizes. His safest channel is the leak.
- **The double layer:** surface account (for the ears) + secret understanding (between the two) runs from Ch4 to the end of Book 1.
...
## 6. Resurrections (pulled from THE MIDDEN — deliberate, logged)
...
**CONTRABAND LIGHT (canon term, on the page).** At a **restricted Balance room** (Ka-Cheryn's; **Justice's mark stands beside Balance's on the lintel**), K proves a **theft of light**: a beam **enters whole (X)** and **leaves halved (X/2)**, and **no second beam feeds the room** — so the room is **keeping half.** K coins the phrase **"contraband light"** — light off the ledger, **taxed at no gate.** It **breaks the creed** (*we lose none of it*), and it is the chapter's **central account-mystery** and the **set-up for Ch5** (Va-Raedin raises it there). **Frame payoff (Ch4 closing bargain).** Old-K, urging Paul to *keep his face*, reveals that Light did not merely catch contraband light but **mapped and tolerated** it: watched every such room, logged which hand and what went in/out and who came and went, and **policed selectively "as it served us,"** the thieves never knowing they were counted. This is his illustration of the surveillance-advantage — *"to know you are watched and have the watcher not know you know it"* — behind the *keep-your-face* pact. **Adds canon:** Light runs a **tolerated-surveillance regime** over contraband light (leverage, not mere enforcement); the **deep purpose** of the stolen light stays the mystery. Prefigures Shadow (Ch6) and rhymes with Sa-Tavan's tablet-blade (K the mapper is himself mapped).
...
**Hanging blade (the cost — Fable's "a cost that sticks").** Before he leaves, Sa-Tavan names a *second* reference class he intends to pull: **every Candidate of Light who went out to the Oasis in his first days, and what followed each such visit** — "the ones that came to nothing, and the ones that did not." He says it **"to the wall, and not to me, which was worse."** So K's arranged testimony is **not** clean away: Justice has quietly flagged *K's own category* for weighing, and the discrepancy (the "mirage" that was not nothing) can still surface. This is a **planted gun — it must threaten or fire later** (Trial-adjacent; the moral deviation now carries a live consequence). It **rhymes with Ch4's own closing bargain** (the *keep-your-face* beat), where K boasts that Light *mapped* every contraband-light room and let the thieves run uncaught: **the counter of counters is now himself being counted.**

**The payoff (Ch12 — the Trial).** The blade falls. At the public Trial **Sa-Tavan is the scribe**, recording the proceeding and about to be dismissed. He never let the *very clean order* go: he kept enquiring in private and set the enquiry on **a separate tablet, which he brings to the Trial** "thinking it might be useful." He **interrupts**, before he is dismissed, to offer **a record not yet closed — an opened investigation, inconclusive — brought in case it should be of use.** What follows is a relay across separated hands, and *the whole chain is never spoken by any one mouth:*

1. **Sa-Tavan:** he has an open, unresolved record on the accused; inconclusive; brought in case it would be of use.
2. **Ka-Leth** — who alone could **link the *mirage* to the tomb from which the proof was carried** (Ch10) — voices **only the shard the law allows:** *"About a mirage? You are correct — this is inconclusive."* He confirms; he does **not** state the link he holds. Two secrets, one mouth: forbidden — his restraint *is* the division of knowledge.
3. **Ka-Dhavar:** *"A mirage, out in the Oasis… let me have a look."* He asks for the tablet — and then **the accusation lands: liar, on the record, *without explanation*, citing the division of knowledge.** That last move is the killer, and it is pure Mountain: the hero is branded a liar *on record* by an authority who **refuses to show his working**, because to lay the whole chain out would be for one hand to hold the whole — forbidden. He is convicted by a system that will not reveal how it knows. At the Oasis he **saw the light, named it a *mirage*, and kept the truth off the record**; the light having been no mirage, he is a **proven liar by his own hand.** It loops the whole way back to the Oasis (Ch3): his first shaping of the truth is the thing that convicts him. And when he fights it — contesting the surfaced record, opening a proceeding *inside* the proceeding (a trial within the trial) — that procedural cunning **reads as what a Mountain-born man would never do and an outsider always would**: the move of an outsider bent on destabilising the Mountain. His competence damns him twice.

- **Dependency resolved:** the *mirage* is unmasked by **the tomb from which the proof was carried** (Ch10) — Ka-Leth makes that link, so "liar" is proof, not assertion. Wire the tomb→Oasis connection when Ch12 is reworked.
- **The device to protect:** condemnation **on record, without explanation, under the division-of-knowledge law.** No one lays out the whole chain (that would be one hand holding the whole); the hero is convicted by a system that refuses to show its working. This is the thematic point, not a bug.
- **[Confirm]** the offices of **Ka-Leth** and **Ka-Dhavar** (two Keepers), and that **Justice** is the hand inheriting Sa-Tavan's tablets — so the fragments pass cleanly.
