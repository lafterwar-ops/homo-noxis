...
> **GUARD (reconciled with §IX / the Noxius Zero canon).** This is the **species-level** casus belli — a whole people's proud, sincere, wrong story told over a sadder biology (their own are *leaving by choice / dissolving into Sapiens*, not merely "stolen"). It must **not** be collapsed into the **founder's personal** origin. Noxius Zero's origin is **not** a jilting: per §IX it is an **intelligence operation and a murder** (Ithe used as an instrument; the father killed; Zero refusing ever to ask how much she chose). The species myth ("they stole our women, who may have chosen") and Zero's private wound (a woman used against him, whom he would not question) **rhyme deliberately** — both are grievances built on a refusal to know — but merging them yields exactly the §XV anti-goal *("a woman rejected a man, therefore apocalypse")*, which is forbidden. Keep them parallel, never identical: the species loses by **attraction** (its people choose the other kind); the founder loses by **operation** (his person is turned into a weapon). The tragedy is that Zero read his private betrayal as proof of the species' myth, and let the smaller true thing become the size of the world.
