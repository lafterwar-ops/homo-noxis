...
- The effect is a **world-reset** — eruption + volcanic winter — that knocks Sapiens back down while Noxis rides it out sealed in the Mountain. This is the "cataclysm," the "cycle" boundary.
...
- **Atlantis / Richat** = a *victim of a prior burn* (a Sapiens high-water civilization reset in an earlier cycle), **not** Noxis's origin or kin. The gravure shows it as evidence of the method, a scorch mark — the Richat is a burn scar, not a cradle.
