...
**Book 5 = the 90-day lock — and its text IS Nocens Zero's autobiography.** Sealed in for the ninety days, with what they have done still warm, the crew reads the Forbidden Archive: the Cycle Ledger, the Year-Clock, and — the terminal reveal — **the autobiography of Nocens Zero, the founder** (see the DEEPEST-EMBARGO canon). K reads it, recognizes himself, and that recognition produces the Declaration.

**The form is the theme — two autobiographies.** Books 1–4 are *K's* autobiography, told to Paul in the account-plus-interview form. **Book 5 keeps that exact form but swaps the narrator: it is *Nocens Zero's* autobiography, read by K and Paul together, with the discussion interludes intact.** The interviewer/interviewee gradient collapses — they are both *readers* now, side by side, undone by the same text, and only K yet knows whose face is in it. The reader spends four books inside one man's life, opens the fifth, finds another man's life in the identical shape, and realizes they are the same life. The mirror at the center becomes the book's own architecture: you do not *tell* the reader that K is Nocens Zero — you make them read it twice and feel it.
...
- *Aborted:* the 90-day lock is the arming window; reading Nocens Zero un-decides the burn before it fires. Cleaner, more hopeful; costs the "press play once" and softens the horror.

Either way the structure locks the same: **Book 4 = Cataclysm; Book 5 = the sealed lock + Nocens Zero's autobiography read by K and Paul; ending on the recognition and the Declaration.**
...
- The effect is a **world-reset** — eruption + volcanic winter — that knocks Sapiens back down while Nocens rides it out sealed in the Mountain. This is the "cataclysm," the "cycle" boundary.
...
## 5. The Year-Clock — specification

**Requirement (François):** an analogue clock that **ticks once per year** — visible, mechanical, of the same kind as the modern "we-think-in-long-time" stunt clock, *except here it was never a stunt.* When a cataclysm is triggered, the crew notes the year, reports it into the Forbidden Archive for the next people, and **resets the clock.**

Real-world anchor (for tone, not for lifting): the once-a-year-tick monumental clock — a hand that moves once per year, slower hands for centuries and millennia, built explicitly to make a civilization feel deep time. In our world it is a gesture. In the Mountain it is load-bearing.
...
- **RESOLVED — *why* the manuscript reaches Sarah:** it is **K's own act, and it is the emotional climax**, not a mechanical gap. In the Archive, K finds **Nocens Zero** (the founder), recognizes himself in him, thinks *enough,* and sends a copy to Sarah to stop the madness. The **why** is now locked; only the mechanical **how** remains, and it simply **rides on Horizon** (Transfer canon). The copy he sends **is this book** — its existence is the Declaration. *(See the DEEPEST-EMBARGO canon: "Nocens Zero — The Founder & the Mirror at the Center." This is the terminal reveal, below all others.)*
...
- **Atlantis / Richat** = a *victim of a prior burn* (a Sapiens high-water civilization reset in an earlier cycle), **not** Nocens's origin or kin. The gravure shows it as evidence of the method, a scorch mark — the Richat is a burn scar, not a cradle.
...
| Manuscript→Sarah | **RESOLVED** — K's own act, triggered by finding **Nocens Zero** and recognizing himself; the copy *is this book* (see Nocens Zero DEEPEST-EMBARGO canon) |
